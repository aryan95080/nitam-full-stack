  ...
  return (
    <form onSubmit={onSubmitHandler} >
      <div>
        ...
        <div className='flex gap-3'>
          <label htmlFor='image1'>
            <img className='w-25' src={!image1?assets.upload_area:URL.createObjectURL(image1)} />
            <input onChange={(e)=>setImage1(e.target.files[0])} type="file" id='image1' hidden />
          </label>
          <label htmlFor='image2'>
            <img className='w-25' src={!image2?assets.upload_area:URL.createObjectURL(image2)} />
            <input onChange={(e)=>setImage2(e.target.files[0])} type="file" id='image2' hidden />
          </label>
          <label htmlFor='image3'>
            <img className='w-25' src={!image3?assets.upload_area:URL.createObjectURL(image3)} />
            <input onChange={(e)=>setImage3(e.target.files[0])} type="file" id='image3' hidden />
          </label>
          <label htmlFor='image4'>
            <img className='w-25' src={!image4?assets.upload_area:URL.createObjectURL(image4)} />
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type="text" required placeholder='Product name' />
      </div>

      <div className='w-full'>
        <p className='my-2'>Description</p>
        <textarea onChange={(e)=>setDiscription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write content here' />
      </div>

      <div className='flex justify-start flex-col sm:flex-row w-full gap-3 sm:gap-8 '>
        <div>
          <p className='my-2'>Category</p>
          <select onChange={(e)=>setCategory(e.target.value)} className='w-full max-w-[500px] px-3 py-2' name="" id="">
        ...
        <div>
          ...
          <select onChange={(e)=>setSubcategory(e.target.value)} className='w-full max-w-[500px] px-3 py-2' name="" id="">
        ...
        <input onChange={(e)=>setPrice(e.target.value)} value={price} className='px-3 py-2 w-full sm:w-[120px]' type="number" placeholder='5000' />
      </div>
      </div>
      <div>

...
const ShopContextProvider=(props)=>{
  ...
  const addToCart=async(itemId,size)=>{
    ...
    if(!size){
      toast.error("Select Procduct Size");
      return;
    }
  ...
  const value={
    products, delivery_fee , currency,search,setSearch,showSearch,setShowSearch,cartItems,addToCart,setCartItems,getCartCount,updateQuantity,getCartAmount,navigate,backendUrl,token,setToken,
  }
  return(

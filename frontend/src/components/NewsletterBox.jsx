...
const NewsletterBox=() =>{  
  ...
  return (
    <div className='text-center'>
      ...
      <form onClick={onSubmitHandler} className='w-2/3 sm:w-1/2 flex items-center gap-auto rounded overflow-hidden mx-auto my-6 border pl-2 bg-green-300 hover:bg-green-400 hover:text-white'>

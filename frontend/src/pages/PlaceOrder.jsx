...
const PlaceOrder=()=>{
  ...
  return (
    <div className='flex flex-col sm:flex-row w-[95%] mx-auto justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      {/*---------------------left side -------------------- */}
      <div className='flex flex-col gap-4 w-full sm:w-[480px]'>
        ...
        <input className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="email" placeholder='email@Example.com' />
        <input className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Street' required />
        <div className='flex gap-3'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-center mt-8'>
            <button onClick={()=>navigate('/orders')} className='bg-black text-white py-3 px-3 rounded text-sm'>PLACE ORDER</button>
          </div>

  ...
  return (
    <div className='w-[95%] mx-auto'>
      ...
      <div className='mt-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        <img className='w-full md:max-w-[480px]' src={assets.hero3} alt="" />
        <div className='flex flex-col justify-center items-start gap-5 mb-20'>
          ...
          <button className='border bg-white rounded border-black px-8 py-4 text-sm hover:bg-black hover:text-white transition-all duration-500'>Explore jobs</button>
        </div>
      </div>
      <NewletterBox/>
    </div>
